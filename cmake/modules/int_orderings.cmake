...
string(TOLOWER "${LIBINT2_SHGAUSS_ORDERING}" LIBINT_SHGAUSS_ORDERING_lower)

if (LIBINT_SHGAUSS_ORDERING_lower STREQUAL "standard")
    set(LIBINT_SHGSHELL_ORDERING ${LIBINT_SHGSHELL_ORDERING_STANDARD})
elseif (LIBINT_SHGAUSS_ORDERING_lower STREQUAL "gaussian")
...
string(TOLOWER "${LIBINT2_CARTGAUSS_ORDERING}" LIBINT_CARTGAUSS_ORDERING_lower)

if (LIBINT_CARTGAUSS_ORDERING_lower STREQUAL "standard")
    set(LIBINT_CGSHELL_ORDERING ${LIBINT_CGSHELL_ORDERING_STANDARD})
elseif (LIBINT_CARTGAUSS_ORDERING_lower STREQUAL "intv3")
    set(LIBINT_CGSHELL_ORDERING ${LIBINT_CGSHELL_ORDERING_INTV3})
elseif (LIBINT_CARTGAUSS_ORDERING_lower STREQUAL "gamess")
    set(LIBINT_CGSHELL_ORDERING ${LIBINT_CGSHELL_ORDERING_GAMESS})
elseif (LIBINT_CARTGAUSS_ORDERING_lower STREQUAL "orca")
    set(LIBINT_CGSHELL_ORDERING ${LIBINT_CGSHELL_ORDERING_ORCA})
elseif (LIBINT_CARTGAUSS_ORDERING_lower STREQUAL "bagel")
...
string(TOLOWER "${LIBINT2_SHELL_SET}" LIBINT_SHELL_SET_lower)

if (LIBINT_SHELL_SET_lower STREQUAL "standard")
    set(LIBINT_SHELL_SET ${LIBINT_SHELL_SET_STANDARD})
elseif (LIBINT_SHELL_SET_lower STREQUAL "orca")
